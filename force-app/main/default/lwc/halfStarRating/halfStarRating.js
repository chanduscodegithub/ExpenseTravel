...
export default class ChildRating extends LightningElement {
    ...
    connectedCallback() {
        ...
        this.rating6 = 'rating6' + this.outerindex + '' + this.innerIndex;
        this.rating7 = 'rating7' + this.outerindex + '' + this.innerIndex;
        this.rating8 = 'rating8' + this.outerindex + '' + this.innerIndex;
        this.rating9 = 'rating9' + this.outerindex + '' + this.innerIndex;
        this.rating10 = 'rating10' + this.outerindex + '' + this.innerIndex;
